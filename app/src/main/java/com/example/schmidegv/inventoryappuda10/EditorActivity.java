package com.example.schmidegv.inventoryappuda10;
...
import com.example.schmidegv.inventoryappuda10.data.ProductContract.ProductEntry;
...
public class EditorActivity extends AppCompatActivity implements
    ...
    public void order(View view) {
        ...
        String message = "Dear " + mSupplierName.getText().toString().trim() + ", \n I would like to order more pieces of " + mNameEditText.getText().toString().trim() +", details below:";
    ...
    private boolean saveProduct() {
        ...
        // Determine if this is a new or existing product by checking if mCurrentPruductUri is null or not
        if (mCurrentProductUri == null) {
            ...
            // In case of an EXISTING product, so update the product with content URI: mCurrentProductUri
